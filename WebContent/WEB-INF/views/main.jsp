                    ...
                    <div class="widget-main no-padding">
                      <div class="dialogs">
                        <div class="itemdiv dialogdiv">
                          <div class="user">
                            <img alt="Alexa's Avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/avatar1.png" />
                          </div>
                        ...
                        <div class="itemdiv dialogdiv">
                          <div class="user">
                            <img alt="John's Avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/avatar.png" />
                          </div>
                        ...
                        <div class="itemdiv dialogdiv">
                          <div class="user">
                            <img alt="Bob's Avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/user.jpg" />
                          </div>
                        ...
                        <div class="itemdiv dialogdiv">
                          <div class="user">
                            <img alt="Jim's Avatar" src="${pageContext.request.contextPath}/resources/assets/avatars/avatar4.png" />
                          </div>
